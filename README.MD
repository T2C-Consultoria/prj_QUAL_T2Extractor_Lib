...
**Interação com OpenAI GPT:** Interage com o OpenAI GPT para captura dados específicos do texto do documento conforme configurações do prompt do OpenAI GPT
